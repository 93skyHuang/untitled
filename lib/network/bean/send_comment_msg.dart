...
class SendCommentMsg {
  ...
  factory SendCommentMsg.fromJson(Map<String, dynamic> json) =>
      _$SendCommentMsgFromJson(json);

  Map<String?, dynamic> toJson() => _$SendCommentMsgToJson(this);
}
