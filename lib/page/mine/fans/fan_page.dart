...
import 'package:untitled/network/bean/cover_follow_info.dart';
...
class _FanPageState extends State<FanPage> with AutomaticKeepAliveClientMixin {
                    ...
                    child: SmartRefresher(
                      ...
                      child: ListView.builder(
                        itemBuilder: (context, index) {
                          return new ItemFan(
                            name: '${fans[index].cname}',
                            img: fans[index].headImgUrl ?? "",
                            info:
                                '${fans[index].distance}，${fans[index].age}，${fans[index].constellation}',
                            onPressed: () {
                              Get.to(() => UserHomePage(uid: fans[index].uid ?? 0));},
                            time: '${fans[index].time}',
                          );
                        },
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: CustomText(
                        ...
                        text: '去开通',
                        textStyle:
                            TextStyle(fontSize: 12, color: Color(0xffFD4343))),
                  )
                ],
              ),
          ],
  ...
  void getList({bool isLoad = false}) {
    getCoverFollowList(pageNo).then((value) => {
          if (value.isOk())
            if (isLoad)
              {
